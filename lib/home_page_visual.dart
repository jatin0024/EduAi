...
class _HomePageState extends State<HomePage> {
  ...
  List<String> videoImageUrls = [
    'https://i.ytimg.com/vi/EAR7De6Goz4/sddefault.jpg',
    ...
    'https://i.ytimg.com/vi/vLqTf2b6GZw/maxresdefault.jpg',
            ...
            DrawerHeader(
              ...
              child: Column(
                ...
                children: [
                  CircleAvatar(
                    radius: 40,
                    backgroundImage: AssetImage('lib/assets/download.jpg'),
                  ),
                  SizedBox(height: 10),
                  Text(
                    'Jatin', // Replace with user's name
